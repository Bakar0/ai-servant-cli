...
import t1 from "./servant_root/.claude/commands/servant/extract-memories.md" with { type: "text" };
...
export const TEMPLATES: ServantTemplate[] = [
  ...
  { rel: "servant_root/.claude/commands/servant/extract-memories.md", content: t1 },
